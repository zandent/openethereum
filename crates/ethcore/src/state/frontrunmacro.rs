...
lazy_static! {
    pub static ref ERC_TOKEN_INFORMATION_MAP: HashMap<Address, (U256, U256)> = 
        [
            ...
            //ETH 18 40205900
            (Address::from_str("0000000000000000000000000000000000000001").unwrap(), (U256::from(15974400),U256::from_dec_str("1000000000000000000").unwrap())),
            //WETH 18
            (Address::from_str("c02aaa39b223fe8d0a0e5c4f27ead9083c756cc2").unwrap(), (U256::from(15974400),U256::from_dec_str("1000000000000000000").unwrap())),
            //3crv 18
