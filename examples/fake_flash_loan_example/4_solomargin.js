...
let source = fs.readFileSync("contracts/out_fake_solomargin/combined.json");
let contracts = JSON.parse(source)["contracts"]['fake_solomargin.sol:fakeSoloMargin'];
